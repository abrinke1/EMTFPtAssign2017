...
// *** Events to process *** //
const int MAX_EVT    = 100000;  // Number of MC events to process
const int MAX_TR     =  50000;  // Number of MC events to use for training
const int REPORT_EVT =   1000;  // Report every Nth event during processing
const int MAX_ZB_FIL =      5;  // Number of ZeroBias files to include (~200 CSC-only, ~50 with RPC)
